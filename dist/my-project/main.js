...
module.exports = "<nav class=\"navbar fixed-top bg-primary\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-brand navbar-light\">\n      <a routerLink=\"../\" class=\"float-left text-white\"><i class=\"fas fa-chevron-left\"></i></a>\n      &nbsp;&nbsp;&nbsp;&nbsp;\n      <a routerLink=\"./\" class=\"text-white\">New Page</a>\n    </div>\n    <a (click)=\"onNewPage()\" style=\"cursor: pointer\" class=\"text-white\">\n      <i class=\"fas fa-check\"></i>\n    </a>\n  </div>\n</nav>\n\n<div class=\"container\">\n  <form>\n    <div class=\"form-group\">\n      <label>Name</label>\n      <input\n        type=\"text\"\n        name=\"pageName\"\n        class=\"form-control\"\n        placeholder=\"Page Name\"\n        required\n        [(ngModel)]=\"newPageName\">\n    </div>\n    <div class=\"form-group\">\n      <label>Title</label>\n      <input\n        type=\"text\"\n        name=\"pageTitle\"\n        class=\"form-control\"\n        placeholder=\"Page Title\"\n        [(ngModel)]=\"newPageTitle\">\n    </div>\n  </form>\n</div>\n\n<nav class=\"navbar fixed-bottom bg-primary\">\n  <div class=\"container-fluid\">\n    <div class=\"ml-auto\">\n      <a [routerLink]=\"['/user', userId]\" class=\"text-white float-right\">\n        <i class=\"fas fa-user\"></i>\n      </a>\n    </div>\n  </div>\n</nav>\n"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        var inputUser = this.userService.findUserByUsername(this.username);
        var authenticatedUser = this.userService.findUserByCredentials(this.username, this.password);
...
module.exports = "<div class=\"container\">\n  <h1>Register</h1>\n\n  <!--Register Form-->\n  <form\n    (ngSubmit)=\"onRegister()\"\n    #form='ngForm'>\n    <div class=\"form-group\">\n      <input\n        class=\"form-control\"\n        placeholder=\"username\"\n        type=\"text\"\n        name=\"username\"\n        required\n        [(ngModel)]=\"registerUsername\"\n        #username=\"ngModel\">\n      <span\n        class=\"help-block\"\n        *ngIf=\"!username.valid && username.touched\">\n        Please enter a valid username\n      </span>\n    </div>\n\n    <div class=\"form-group\">\n      <input\n        class=\"form-control\"\n        placeholder=\"password\"\n        type=\"password\"\n        name=\"password\"\n        required\n        [(ngModel)]=\"registerPassword\"\n        #password=\"ngModel\">\n      <span\n        class=\"help-block\"\n        *ngIf=\"!password.valid && password.touched\">\n        Please enter a valid password\n      </span>\n    </div>\n\n    <div class=\"form-group\">\n      <input\n        class=\"form-control\"\n        placeholder=\"verify password\"\n        type=\"password\"\n        name=\"verifiedPassword\"\n        required\n        [(ngModel)]=\"registerVerifiedPassword\"\n        #verifiedPassword=\"ngModel\">\n      <span\n        class=\"help-block\"\n        *ngIf=\"(registerPassword !== registerVerifiedPassword || !verifiedPassword.valid) && verifiedPassword.touched\">\n        Please enter the same password\n      </span>\n    </div>\n\n    <div class=\"form-group\">\n      <button\n        class=\"btn btn-primary btn-block\"\n        type=\"submit\"\n        [disabled]=\"!form.valid || registerPassword !== registerVerifiedPassword\">\n        Register\n      </button>\n    </div>\n    <div class=\"form-group\">\n      <a class=\"btn btn-danger btn-block\" (click)=\"onCancel()\">Cancel</a>\n    </div>\n  </form>\n</div>\n"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegister = function () {
        ...
        var loginUser = this.userService.findUserByCredentials(this.registerUsername, this.registerPassword);
...
module.exports = ".nav-item {\n  float: left;\n  color: white;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark bg-primary justify-content-start mb-2\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-brand navbar-dark\">\n      <a routerLink=\"../\" class=\"nav-item nav-link turnwhite\"><i class=\"fas fa-chevron-left\"></i></a>\n      <a routerLink=\"./\" class=\"navbar-brand\">Websites</a>\n    </div>\n    <a routerLink=\"./new\" class=\"av-item nav-link ml-auto text-white\"><i class=\"fas fa-plus turnwhite\"></i></a>\n  </div>\n</nav>\n\n<div class=\"container\">\n  <div class=\"form-control\" *ngFor=\"let website of websites\">\n      <a [routerLink]=\"['./', website._id, 'page']\">{{ website.name }}</a>\n      <a [routerLink]=\"['./', website._id]\" class=\"text-blue float-right\"><i class=\"fas fa-cog turnwhite\"></i></a>\n  </div>\n</div>\n\n<nav class=\"navbar fixed-bottom bg-primary navbar-dark justify-content-end\">\n  <div class=\"container-fluid\">\n    <div class=\"ml-auto\">\n      <a [routerLink]=\"['/user', userId]\" class=\"text-white float-right\">\n        <i class=\"fas fa-user turnwhite\"></i>\n      </a>\n    </div>\n  </div>\n</nav>\n"
